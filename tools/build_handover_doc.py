...
table(
    ...
    [
        ...
        ["Knowledge base — read & search", "/knowledge", "Yes", "Yes", "Yes"],
        ["Knowledge base — upload / edit", "/knowledge", "All documents", "Own uploads only", "No"],
        ...
        ["Department area", "/departments/[id]", "Any",
        ...
        ["Knowledge base admin", "/system/knowledge-base", "Yes", "No", "No"],
